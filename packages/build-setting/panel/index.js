        ...
        window.plugin = new window.Vue({
            ...
            methods: {
                ...
                onDelete() {
                    ...
                    CfgUtil.setIsDelete(this.isDelete);
                    this._addLog('图片删除选项: ' + this.isDelete);
                },
                ...
                onSaveCfg() {
                    CfgUtil.setConfig(this.targetDir, this.encryptPrefix, this.encryptKey, this.version, this.packageUrl);
                },
                onManifestUUID() {
                ...
                onModified() {
                    if(!this.targetDir)
                    {
                        this._addLog("默认将会删除整个resources中的png图片");
                    }
