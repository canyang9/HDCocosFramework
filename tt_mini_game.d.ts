...
declare const tt: {
    getMenuButtonLayout(): any

    showMoreGamesModal(obj: { appLaunchOptions: Array<{ appId: string, query?: string, extraData?: object }>, 
        success?: Function, fail?: Function })

    onMoreGamesModalClose(cb: Function)

    onNavigateToMiniProgram(cb: Function)

    offNavigateToMiniProgram(cb?: Function)

    getGameRecorderManager()

    /** type: text/image, image: 当type为image时有效， text： 当type为text时有效 */
    createMoreGamesButton(obj: { type: string, style: MoreGameStyle, 
        appLaunchOptions: Array<{ appId: string, query?: string, extraData?: object }>,
        image?: string, text?: string, onNavigateToMiniGame?: Function }): MoreGamesButton
     ...
     * 主动拉起转发，进入选择通讯录界面。
     */
    shareAppMessage(object: {channel?:string,title?:string,imageUrl?:string,query?:string,desc?:string,templateId?:string,extra?:object,
        success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void,cancel?:(res:any)=>void}): void;
...
declare interface GameRecorderManager {
    ...
    recordClip(obj: { timeRange?: Array<number>, success?: Function, fail?: Function, complete?: Function })

    /** success返回对象参数的扩展属性,videoPath剪辑的视频地址 */
    clipVideo(obj: { path: string, timeRange?: Array<number>, clipRange?: Array<number>, 
        success?: Function, fail?: Function })
...
declare interface MoreGamesButton {
    onTap(cb: Function)
...
declare interface MoreGameStyle {
    left: number
    top: number
    width: number
    height: number
