...
declare const swan: {
    ...
    createGameClubButton(obj: { type: string, text: string, image: string, 
        style: { left: number, top: number, width: number, height: number, 
            ...
            borderRadius?: number, textAlign?: string, fontSize?: number, lineHeight?: number }, icon: string }): GameClubButton

    createUserInfoButton(obj: { type: string, text: string, image: string, 
        style: any, withCredentials: boolean, lang: string = 'zh_CN' }): UserInfoButton;
    /**
...
declare interface videoRecorderManager {
    start(opts: { duration: number = 10, microphoneEnabled: boolean = false })
